...
ActiveRecord::Schema[8.1].define(version: 2026_04_30_162040) do
  ...
  create_table 'currency_transactions', force: :cascade do |t|
    ...
    t.index %w[transactionable_type transactionable_id], name: 'index_currency_transactions_on_transactionable'
  end
  ...
  create_table 'story_group_students', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id'
    t.index %w[user_id story_group_id], name:   'index_story_group_students_on_user_id_and_story_group_id',
                                        unique: true
  end
  ...
  create_table 'story_group_teachers', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id'
    t.index %w[user_id story_group_id], name:   'index_story_group_teachers_on_user_id_and_story_group_id',
                                        unique: true
  end
  ...
  create_table 'students_activity_group_categories', force: :cascade do |t|
    ...
    t.index %w[student_id activity_group_category_id], name:   'index_student_activity_group_categories_unique',
                                                       unique: true
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[usos_id university_name], name: 'index_users_on_usos_id_and_university_name', unique: true
  end
