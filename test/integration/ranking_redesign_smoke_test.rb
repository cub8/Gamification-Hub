...
# "Ranking" — RankingController, converted to the redesign layout.
...
# students see.
class RankingRedesignSmokeTest < ActionDispatch::IntegrationTest
  def group(**attrs)
  ...
  test 'the ranking renders inside the redesign chrome for a teacher' do
  ...
  test 'the ranking renders inside the redesign chrome for a student' do
    story_group = group(ranking_enabled: true)
