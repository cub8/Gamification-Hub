...
class Redesign::TeacherListTest < ActiveSupport::TestCase
  setup do
  ...
  def list = Redesign::TeacherList.new(story_group: @story_group)
  ...
  test 'it lists the memberships it is given' do
    supporting('Adam Adamczyk')
    scoped = Redesign::TeacherList.new(story_group: @story_group,
